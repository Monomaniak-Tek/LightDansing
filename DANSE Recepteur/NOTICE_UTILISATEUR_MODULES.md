...
3. Sur smartphone, se connecter au Wi-Fi `DANSE`.
4. Mot de passe Wi-Fi: `fiona123`.
...
2. Dans les 5 secondes apres demarrage, maintenir le bouton `BOOT` (GPIO0) ~1 seconde.
...
4. Le mot de passe Wi-Fi est connu de l'operateur.
5. Un test de tous les effets est valide avant public.

## 8. Depannage rapide
### A. Je ne vois pas le Wi-Fi `DANSE`
